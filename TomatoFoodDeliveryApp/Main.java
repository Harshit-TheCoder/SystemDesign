...
import TomatoFoodDeliveryApp.strategies.UpiPaymentStrategy;
...
public class Main {
    public static void main(String[] args) {
        ...
        java.util.List<Restuarent> restaurantList = tomato.searchRestuarents("Delhi");
        ...
        System.out.println("Found Restuarents:");
        for (Restuarent restaurant : restaurantList) {
            System.out.println(" - " + restaurant.getName());
        }

        // User selects a restaurant
        tomato.selectRestuarent(user, restaurantList.get(0));
